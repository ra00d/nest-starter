(() => {
  ...
  function Tn(e) {
    U.includes(e) || U.push(e), Rn();
  }
  function ve(e) {
    let t = U.indexOf(e);
    t !== -1 && t > ot && U.splice(t, 1);
  }
  function Rn() {
    !it && !nt && ((nt = !0), queueMicrotask(Mn));
  }
  function Mn() {
    (nt = !1), (it = !0);
    for (let e = 0; e < U.length; e++) U[e](), (ot = e);
    (U.length = 0), (ot = -1), (it = !1);
  }
  var R,
    D,
    j,
  ...
  function dt() {
    Nn(), ut.disconnect(), (ft = !1);
  }
  var ue = [];
  function Nn() {
    let e = ut.takeRecords();
    ue.push(() => e.length > 0 && mt(e));
    let t = ue.length;
    queueMicrotask(() => {
  ...
  function mt(e) {
    ...
    for (let o of r) t.has(o) || Xt.forEach((s) => s(o));
    t.forEach((o) => {
    ...
    return (
      Object.entries(nr).forEach(([r, n]) => {
        ...
        function o() {
          ...
          {
            let [s, a] = _t(t);
            return (i = { interceptor: Me, ...s }), te(t, a), i;
          }
        }
...
`
  ...
  function In(e, t) {
    ...
    W(r, e);
    let n = [r, ...P(e)],
      i = typeof t == 'function' ? xt(n, t) : Ln(n, t, e);
  ...
  function X(e, t) {
    return typeof t == 'object' && t !== null ? Hn(e, t) : Vn(e, t);
  }
  function Hn(e, t) {
    let r = {};
    return (
  ...
  d(
    ...
    (e, { value: t, modifiers: r, expression: n }, { evaluate: i }) => {
      typeof n == 'function' && (n = i(n)),
        n !== !1 && (!n || typeof n == 'boolean' ? Wn(e, r, t) : Un(e, n, t));
    },
  );
  function Un(e, t, r) {
    Sr(e, me, ''),
      ...
      Number.isInteger(t)
        ...
        : !Array.isArray(t) &&
          ...
          : Array.isArray(t)
            ...
            : (e.checked = !!t);
    else if (e.tagName === 'SELECT') ri(e, t);
    else {
      if (e.value === t) return;
      e.value = t === void 0 ? '' : t;
    }
  ...
  function Ir(e, t, r, n = !0) {
    ...
    if (e._x_inlineBindings && e._x_inlineBindings[t] !== void 0) {
      ...
      return (i.extract = n), Pe(() => M(e, i.expression));
    }
    return $r(e, t, r);
  }
  function $r(e, t, r) {
  ...
  var Z = {},
    jr = !1;
  function Fr(e, t) {
    if ((jr || ((Z = R(Z)), (jr = !0)), t === void 0)) return Z[e];
    (Z[e] = t),
      typeof t == 'object' &&
        t !== null &&
  ...
  function Kr(e, t) {
    ...
    return e instanceof Element ? Tt(e, r()) : ((zr[e] = r), () => {});
  }
  function Hr(e) {
    return (
  ...
  var oi = {
      ...
      disableEffectScheduling: Wt,
      startObservingMutations: fe,
      stopObservingMutations: dt,
      setReactivityEngine: Gt,
  ...
  function Wr(e, t) {
    let r = si(e);
    if (typeof t == 'function') return xt(r, t);
    let n = ai(e, t, r);
  ...
  function ai(e, t, r) {
    return (n = () => {}, { scope: i = {}, params: o = [] } = {}) => {
      let s = I([i, ...r]);
      s[t] === void 0 && ci(e, t), ne(n, s[t], s, o);
    };
  }
  function ci(e, t) {
    console.warn(
...
`,
  ...
  var We = (e) => {
    ...
    pi = /-(\w)/g,
    zs = We((e) => e.replace(pi, (t, r) => (r ? r.toUpperCase() : ''))),
    mi = /\B([A-Z])/g,
    Ks = We((e) => e.replace(mi, '-$1').toLowerCase()),
  ...
  function rn(e) {
    e.active &&
      (nn(e), e.options.onStop && e.options.onStop(), (e.active = !1));
  }
  var _i = 0;
  function gi(e, t) {
    let r = function () {
    ...
    if (t === 'clear') s.forEach(c);
      ...
      switch ((r !== void 0 && c(s.get(r)), t)) {
        case 'add':
          H(e)
            ? Ue(r) && c(s.get('length'))
            : (c(s.get(Q)), se(e) && c(s.get(kt)));
          break;
        case 'delete':
          H(e) || (c(s.get(Q)), se(e) && c(s.get(kt)));
          break;
        case 'set':
          se(e) && c(s.get(Q));
          break;
  ...
  function an(e = !1, t = !1) {
    return function (n, i, o) {
      ...
      if (i === '__v_raw' && o === (e ? (t ? Fi : fn) : t ? ji : un).get(n))
        return n;
      let s = H(n);
      if (!e && s && ye(Yr, i)) return Reflect.get(Yr, i, o);
      let a = Reflect.get(n, i, o);
      return (qe(i) ? sn.has(i) : bi(i)) || (e || N(n, 'get', i), t)
        ? a
        : It(a)
          ? !s || !Ue(i)
            ? a.value
  ...
  function Ai(e = !1) {
    return function (r, n, i, o) {
      let s = r[n];
      if (!e && ((i = _(i)), (s = _(s)), !H(r) && It(s) && !It(i)))
        return (s.value = i), !0;
      let a = H(r) && Ue(n) ? Number(n) < r.length : ye(r, n),
        c = Reflect.set(r, n, i, o);
      return (
        r === _(o) &&
          (a ? Dt(i, s) && q(r, 'set', n, i, s) : q(r, 'add', n, i)),
        c
      );
    };
  }
  ...
  function Ci(e, t) {
    ...
    return (!qe(t) || !sn.has(t)) && N(e, 'has', t), r;
  }
  function Ti(e) {
    return N(e, 'iterate', H(e) ? 'length' : Q), Reflect.ownKeys(e);
  }
  var Ri = { get: wi, set: Si, deleteProperty: Oi, has: Ci, ownKeys: Ti },
    Mi = {
      get: Ei,
      set(e, t) {
        return (
  ...
  function Ye(e, t = !1) {
    return (
      (e = e.__v_raw), !t && N(_(e), 'iterate', Q), Reflect.get(e, 'size', e)
    );
  }
  function Xr(e) {
    e = _(e);
    let t = _(this);
    return Qe(t).has.call(t, e) || (t.add(e), q(t, 'add', e, e)), this;
  }
  function Zr(e, t) {
    t = _(t);
    let r = _(this),
      { has: n, get: i } = Qe(r),
      o = n.call(r, e);
    o ? ln(r, n, e) : ((e = _(e)), (o = n.call(r, e)));
    let s = i.call(r, e);
    return (
      r.set(e, t),
      o ? Dt(t, s) && q(r, 'set', e, t, s) : q(r, 'add', e, t),
      this
    );
  }
  function Qr(e) {
  ...
  function Xe(e, t) {
    return function (n, i) {
      let o = this,
        ...
        c = t ? Ft : e ? jt : Lt;
      return (
        !e && N(a, 'iterate', Q), s.forEach((l, u) => n.call(i, c(l), c(u), o))
      );
    };
  }
  function Ze(e, t, r) {
  ...
  function et(e) {
    return e && e.__v_isReadonly ? e : pn(e, !1, Ri, $i, un);
  }
  function dn(e) {
    return pn(e, !0, Mi, Li, fn);
  }
  ...
  y(
    'refs',
    (e) => (e._x_refs_proxy || (e._x_refs_proxy = I(Ki(e))), e._x_refs_proxy),
  );
  function Ki(e) {
    let t = [];
    return (
  ...
  var xn = () => {};
  xn.inline = (e, { modifiers: t }, { cleanup: r }) => {
  ...
  function Ji(e, t) {
    ...
    if (r.length === 0 || (r.length === 1 && yn(e.key).includes(r[0])))
      return !1;
    ...
    return (
      ...
      !(
        ...
        (bn(e.type) || yn(e.key).includes(r[0]))
      )
    );
  }
  function yn(e) {
  ...
  d(
    ...
    (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
      ...
      let c = () => {
          let m;
          return s((w) => (m = w)), wn(m) ? m.get() : m;
        },
        l = (m) => {
          let w;
          s((F) => (w = F)),
            wn(w) ? w.set(m) : a(() => {}, { scope: { __placeholder: m } });
        };
      typeof r == 'string' &&
        e.type === 'radio' &&
        h(() => {
      ...
      if (
        ...
        let m = ce(e.form, 'reset', [], (w) => {
          oe(() => e._x_model && e._x_model.set(Kt(e, t, { target: e }, c())));
        });
        i(() => m());
      }
      (e._x_model = {
  ...
  En.inline = (e, { value: t, modifiers: r, expression: n }) => {
    t &&
  ...
  function eo(e, t, r, n) {
    ...
    r((s) => {
      ...
      for (let f = 0; f < p.length; f++) {
        ...
        let O = l[b],
          ee = u[b],
          le = document.importNode(o.content, !0).firstElementChild,
          qt = R(O);
        k(le, qt, o),
          (le._x_refreshXForScope = (An) => {
            Object.entries(An).forEach(([On, Cn]) => {
              qt[On] = Cn;
            });
          }),
          h(() => {
  ...
  B.setEvaluator(Wr);
  B.setReactivityEngine({ reactive: et, effect: tn, release: rn, raw: _ });
  var Vt = B;
  window.Alpine = Vt;
  queueMicrotask(() => {
    Vt.start();
